/**
  ...
  * @file    stm32mp13xx_disco.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage LEDs,
  *          push-buttons and COM ports available on STM32MP13xx-DISCO
...
/** @defgroup STM32MP13XX_DISCO_LOW_LEVEL_Private_TypesDefinitions Private Typedef
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_LOW_LEVEL_Private_Defines Private Def
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_LOW_LEVEL_Private_FunctionPrototypes Private Prototypes
  * @{
  */
#ifdef HAL_EXTI_MODULE_ENABLED
...
/** @addtogroup STM32MP13XX_DISCO_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */

  /**
  * @brief  This method returns the STM32MP13XX DISCO BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return STM32MP13XX_DISCO_BSP_VERSION;
}
...
int32_t BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  int32_t  status = BSP_ERROR_NONE;
  GPIO_InitTypeDef      gpio_init_structure;
  static uint32_t  BSP_BUTTON_IT_PRIORITY[BUTTONn] = {BSP_BUTTON_WAKEUP_IT_PRIORITY, BSP_BUTTON_USER_IT_PRIORITY, BSP_BUTTON_USER2_IT_PRIORITY, BSP_BUTTON_TAMPER_IT_PRIORITY};
#ifdef HAL_EXTI_MODULE_ENABLED
  static uint32_t  BUTTON_EXTI_LINE[BUTTONn]   = {WAKEUP_BUTTON_EXTI_LINE, USER_BUTTON_EXTI_LINE, USER2_BUTTON_EXTI_LINE, TAMPER_BUTTON_EXTI_LINE};
  static BSP_EXTI_LineCallback  ButtonCallback[BUTTONn]     = {BUTTON_WAKEUP_EXTI_Callback, BUTTON_USER_EXTI_Callback, BUTTON_USER2_EXTI_Callback, BUTTON_TAMPER_EXTI_Callback};
#endif
...
/**
  * @brief  This function handles EXTI_LINE_6 interrupt request.
  * @retval None
  */
...
/** @addtogroup STM32MP13XX_DISCO_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */

#ifdef HAL_EXTI_MODULE_ENABLED
/** @addtogroup STM32MP13XX_DISCO_LOW_LEVEL_Private_Functions_Group1 BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
#ifdef HAL_UART_MODULE_ENABLED
/** @addtogroup STM32MP13XX_DISCO_LOW_LEVEL_Private_Functions_Group2 COM Functions
  * @{
  */
/**
