/**
  ******************************************************************************
  * @file    stm32mp13xx_disco_ts.c
  * @author  MCD Application Team
  * @brief   This file provides a set of functions needed to manage the Touch
  *          Screen on STM32MP135F-DK board.
  @verbatim
   1. How To use this driver:
   --------------------------
      - This driver is used to drive the touch screen module of the STM32MP135F-DK
        board on the RK043FN48H-CT672B 480x272 LCD screen with capacitive touch screen.
      - The GT911 component driver must be included in project files according to
...
/** @addtogroup STM32MP135F-DK
  * @{
  */

/** @defgroup STM32MP135F-DK_TS TS
  * @{
  */

/** @defgroup STM32MP135F-DK_TS_Private_Types_Definitions Private Types Definitions
  * @{
  */
...
/** @defgroup STM32MP135F-DK_TS_Private_Defines Private Types Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32MP135F-DK_TS_Private_Macros Private Macros
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32MP135F-DK_TS_Private_Function_Prototypes Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32MP135F-DK_TS_Privates_Variables Privates Variables
  * @{
  */
...
/** @defgroup STM32MP135F-DK_TS_Exported_Variables Exported Variables
  * @{
  */
#ifdef HAL_EXTI_MODULE_ENABLED
...
/** @defgroup STM32MP135F-DK_TS_Exported_Functions Exported Functions
  * @{
  */
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        GIC_SetPriority((IRQn_Type)(TS_INT_EXTI_IRQn), 0x00);
        GIC_EnableIRQ((IRQn_Type)(TS_INT_EXTI_IRQn));
      }
    }
  }
  ...
  else
  {
    ...
    case GT911_GEST_ID_NO_GESTURE :
      *GestureId = GESTURE_ID_NO_GESTURE;
      break;
    case GT911_GEST_ID_MOVE_UP :
      *GestureId = GESTURE_ID_MOVE_UP;
      break;
    case GT911_GEST_ID_MOVE_RIGHT :
      *GestureId = GESTURE_ID_MOVE_RIGHT;
      break;
    case GT911_GEST_ID_MOVE_DOWN :
      *GestureId = GESTURE_ID_MOVE_DOWN;
      break;
    case GT911_GEST_ID_MOVE_LEFT :
      *GestureId = GESTURE_ID_MOVE_LEFT;
      break;
    case GT911_GEST_ID_ZOOM_IN :
      *GestureId = GESTURE_ID_ZOOM_IN;
      break;
    case GT911_GEST_ID_ZOOM_OUT :
...
/**
  * @}
  */
/** @defgroup STM32MP135F-DK_TS_Private_Functions Private Functions
  * @{
  */
