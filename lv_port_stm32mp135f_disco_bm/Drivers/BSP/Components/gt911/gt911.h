...
#define GT911_GEST_ID_MOVE_UP           0x10U
#define GT911_GEST_ID_MOVE_RIGHT        0x14U
#define GT911_GEST_ID_MOVE_DOWN         0x18U
#define GT911_GEST_ID_MOVE_LEFT         0x1CU
#define GT911_GEST_ID_ZOOM_IN           0x48U
#define GT911_GEST_ID_ZOOM_OUT          0x49U
...
typedef struct
{
  ...
  /*uint32_t  TouchEvent[GT911_MAX_NB_TOUCH]*/
 ...
 typedef struct
{
  ...
  int32_t ( *ReadID               ) ( GT911_Object_t *, volatile uint32_t * );
